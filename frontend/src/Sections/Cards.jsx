...
function Cards({ item }) {
  return (
    <div className="card w-96 bg-base-100 shadow-xl image-full mt-3 mb-6 my-3 hover:scale-105 transition-transform duration-300 dark:bg-black dark:text-white">
